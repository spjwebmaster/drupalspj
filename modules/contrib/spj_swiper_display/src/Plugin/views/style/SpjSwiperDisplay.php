 ...
 *
 * @ViewsStyle(
 *   id = "spj_swiper_display",
 *   title = @Translation("SPJ Swiper Display"),
 *   help = @Translation("Displays rows as swiper slider"),
...
class SpjSwiperDisplay extends StylePluginBase {
