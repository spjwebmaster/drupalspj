...
class ImpexCreds {
    ...
    public function getCreds(){
        ...
        $formID = 'impexcreds_configuration_form';
    ...
    public function get_impexium_user($email){
        ...
        $data = ImpexCreds::send_request(ACCESS_END_POINT, $data);
        ...
        $data = ImpexCreds::send_request($apiEndPoint, $data, array(
        ...
        $userdata = ImpexCreds::send_request($baseUri . $urlPath, null, array(
            'usertoken: ' . $userToken,
            'apptoken: ' . $appToken,
        ));
